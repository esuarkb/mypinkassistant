...
UI_EN = {
    ...
    "customer_tax_set": "✅ {name}'s tax rate set to <strong>{rate}%</strong>. Future orders will use it automatically.",
    "customer_tax_cleared": "✅ Cleared {name}'s saved tax rate. Future orders go back to your default rate.",
...
UI_ES = {
    ...
    "customer_tax_set": "✅ Tasa de impuesto de {name} establecida en <strong>{rate}%</strong>. Los pedidos futuros la usarán automáticamente.",
    "customer_tax_cleared": "✅ Se borró la tasa de impuesto guardada de {name}. Los pedidos futuros vuelven a tu tasa predeterminada.",
